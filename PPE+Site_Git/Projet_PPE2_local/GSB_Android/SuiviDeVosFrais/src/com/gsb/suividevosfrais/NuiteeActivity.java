...
/**
 * Classe d'activité pour les frais de nuits
...
public class NuiteeActivity extends Activity {
	...
	/**
	 * Sur le clic du bouton moins : enl�ve 1 dans la quantit� si possible
	 */
	...
	private void enregNewQte(){
		...
		Integer key = annee*100+mois;
		if(!Global.listFraisMois.containsKey(key)){
			//cr�ation du mois et de l'ann�e s'ils n'existent pas d�ja
	...
	/**
	 * Retour a l'activit� principale (le menu)
	 */
